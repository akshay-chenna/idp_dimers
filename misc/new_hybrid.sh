...
hybrid() {
	for i in {1..125} # Number of serial runs on each core
		do
...
gmx_mpi make_ndx -f em${line}.gro -n ${line}.ndx -o ind.ndx << EOF
2 & r 1-70
1 | 3
1 & a C CA N
3 & a C CA N
q
EOF
		echo 4 4 | gmx_mpi trjconv -f em${line}.gro -s em${line}.gro -o p${line}.gro -n ind.ndx -center
		gmx_mpi sasa -f p${line}.gro -s p${line}.gro -or ../../areas/complex_r${line} -oa ../../areas/complex_a${line} -o ../../areas/complex_t${line} -surface 4 -output 4 -ndots 200 -n ind.ndx &
		gmx_mpi sasa -f p${line}.gro -s p${line}.gro -or ../../areas/nsp7_r${line} -oa ../../areas/nsp7_a${line} -o ../../areas/nsp7_t${line} -surface 3 -output 3 -ndots 200 -n ind.ndx &
		...
		timeout 7m echo 1 3 | mpirun -np 1 -host `sed "$2q;d" $PBS_NODEFILE` ./g_mmpbsa -f em${line}.gro -s em${line}.tpr -n ind.ndx -i mmpbsa.mdp -pdie 4 -mme -mm mm.xvg -pbsa -pol pol.xvg -apol apol.xvg -decomp -mmcon contrib_mm_${line}.dat -pcon contrib_pol_${line}.dat -apcon contrib_apol_${line}.dat 
...
node=1
for task in $( eval echo {$(((j-1)*80+1))..$((j*80))}) # Number of parallel runs
do
	node=$((node+1))
	hybrid $task $node &
done
