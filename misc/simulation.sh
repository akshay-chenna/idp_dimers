...
gmx_mpi grompp -f sa.mdp -c em2.gro -r em2.gro -p topol.top -o sa.tpr -po saout.mdp
...
gmx_mpi grompp -f nvt.mdp -c sa.gro -r sa.gro -p topol.top -o nvt.tpr -po nvtout.mdp
...
gmx_mpi grompp -f npt.mdp -c nvt.gro -r nvt.gro -p topol.top -o npt.tpr -po nptout.mdp
...
gmx_mpi grompp -f md.mdp -c npt.gro -r npt.gro -p topol.top -o md.tpr -po mdout.mdp
