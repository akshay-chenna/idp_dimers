...
cd /home/chemical/phd/chz198152/scratch/rosetta_1c/
module load apps/Rosetta/2020.03/intel2019

#np=80 				# Number of parallel processes
nstruct=100160			# Number of decoys to be generated
name=lowres 			# Name of all generated files and folders except *.pdb
