...
for i in range(0,len(u.trajectory)):
    ...
    r = rms.RMSD(u, v, select=(selection,selection), ref_frame=i).run()
    x[i,:] = r.rmsd[:,2]

np.save('rmsd_1wrt2.npy',x)
...
plt.savefig('rmsd_cross1wrt2.jpg')